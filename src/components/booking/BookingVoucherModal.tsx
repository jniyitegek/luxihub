        ...
        <div className="p-8 space-y-6 print:p-6 print:space-y-4">
          ...
          <div className="flex items-start justify-between border-b border-slate-200 pb-6">
            ...
            <div className="text-right">
              ...
              <div className="inline-flex items-center gap-1 mt-1 px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 text-[10px] font-bold">
